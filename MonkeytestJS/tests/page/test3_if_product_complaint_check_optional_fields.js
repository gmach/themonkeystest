registerTest ("The form cannot be submitted if the enquiry type is Product complaint and product name, product size, use-by date and batch code are empty.", {
    ...
    load : function($) {
        this
        .test("The form cannot be submitted if the enquiry type is Product complaint and product name, product size, use-by date and batch code are empty.",function($) {
